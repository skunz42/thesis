...
\par On a greater scale, Figure (REF) displays the cumulative distribution function of the data. The average crime discussion percentage lays at 3.5\%.

(FIG)

\par Furthermore, Figure (REF) displays a map of all Metropolitan Areas by the percentage of crime posts submitted to their respective subreddits. The darker the shade of green, the more posts discuss crime.
...
\subsection{Crime Discussion and Documented Crime}
